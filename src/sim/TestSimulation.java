...
public class TestSimulation 
{
	public static void main(String[] args) 
	{
		...
		for (int i = 0; i < 50; i++) 
		{
			...
			bati.addRule(new Eat(FoodType.vegetable, 2));
		...
		for(int i = 0; i < 2; i++)
		{
			...
			malolo.addRule(new Eat(FoodType.animal, 2));
		...
		for (int i = 0; i < 100; i++) 
		{
			Pop sandwitch = new Pop("sandwich", simulation, FoodType.vegetable, 1);
			sandwitch.addRule(new Reproduce(0));
			simulation.addPop(sandwitch);
		}
